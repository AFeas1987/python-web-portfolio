...
# admin.site.register(WorkExperience, SingletonModelAdmin)
admin.site.register(Experience, admin.ModelAdmin)
# admin.site.register(Education, SingletonModelAdmin)
...
# from .models import About, SocialIcon, ExperienceEntry, EducationEntry
# config = AboutAdmin.objects.get_solo()

# get_solo will create the item if it does not already exist
# about = About.get_solo()
# experience = WorkExperience.get_solo()
# education = Education.get_solo()